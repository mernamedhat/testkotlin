...
class MainActivity2 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       //Shared
        ...
        // access the spinner
        val Education = arrayOf("Fci", "Commerce College", "Art University", "College of education", "College of Engineering",
            "School of Law")
            ...
            spinner.onItemSelectedListener = object :
                ...
                override fun onItemSelected(parent: AdapterView<*>,
                    ...
                    Toast.makeText(this@MainActivity2,
                        "selected_item" + " " +
                                "" + Education[position], Toast.LENGTH_SHORT).show()
                }
        ...
        confirm .setOnClickListener {
           // Firstname.text.toString().trim().toInt()
            ...
            if (CheckBox.isChecked){
                ...
                Toast.makeText(this@MainActivity2,
                    "select the  CheckBox" , Toast.LENGTH_SHORT).show()
            }
